...
df["NearestStationBreadth_mean"] = df.groupby("NearestStation")["Breadth"].transform("mean")
df["NearestStationBreadth_std"]  = df.groupby("NearestStation")["Breadth"].transform("std")
